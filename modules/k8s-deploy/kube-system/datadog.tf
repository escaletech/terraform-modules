resource "helm_release" "datadog_agent" {
  ...
  set {
    ...
    value = "kube_namespace:lead-data-platform kube_namespace:lead-platform kube_namespace:finance-bv kube_namespace:zelas-saude kube_namespace:escale-os-bff kube_namespace:finance-qista"
  }
